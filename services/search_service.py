...
class SearchService:
    ...
    def hybrid_search(
        ...
        try:
            ...
            logger.info(f"Hybrid search completed: query='{query[:30]}...', results={len(output)}")
            return output
    ...
    def keyword_search(
        ...
        try:
            ...
            logger.info(f"Keyword search completed: query='{query[:30]}...', results={len(output)}")
            return output
